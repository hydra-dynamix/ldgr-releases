...
[`database-contract-7e177ee30c2`](https://github.com/hydra-dynamix/ldgr-releases/releases/tag/database-contract-7e177ee30c2).
...
LDGR Core 0.1.10 or newer within the 0.1 release family.
